...
//         if (isEmpty($('#ten_nhantin').val(), "Xin nhập Họ tên")) { $('#ten_nhantin').focus(); return false; }
//         if (isEmpty($('#dienthoai_nhantin').val(), "Xin nhập Số điện thoại")) { $('#dienthoai_nhantin').focus(); return false; }
//         if (isEmpty($('#diachi_nhantin').val(), "Xin nhập Địa chỉ")) { $('#diachi_nhantin').focus(); return false; }
